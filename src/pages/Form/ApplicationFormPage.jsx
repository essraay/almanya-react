import { CContainer, CRow, CFormInput, CCard, CCardBody, CFormSelect, CButton, CFormText, CFormCheck, CForm } from "@coreui/react"
...
const ApplicationFormPage = () => {
  ...
  const submit = () => {
    ...
    ApplicationFormService.createApplication({ ...informationFormData, ...fileFormData, otherLanguageId: 1, categoryId }).then((response) => {
  ...
  const activeProvince = useMemo(() => {
    return provinceId && provinceList.length > 0 ? provinceList.find(province => province.id == provinceId) : undefined
  ...
  if (state === 'fileForm') return <>
    {/* <CButton onClick={() => { setState('informationForm') }}>Degiştir</CButton> */}
    <ApplicationFormTwo onChange={setFileFormData} onSubmit={submit} />
  </>
                ...
                >
                  ...
                  >
                    <CRow>
                      ...
                      <div className="form-group col-md-6" style={{ color: '#6D4D4D' }}>
                        <CFormInput
                          type="text"
                          name='tc'
                          label="TC"
                    ...
                    <CRow>
                      <div className="form-group col-md-6" style={{ color: '#6D4D4D', margin: '1% 0' }}>
                        <CFormInput
                          type="text"
                          name='name'
                          label="Adınız"
                    ...
                    <div className="form-block" style={{ color: '#6D4D4D', margin: '1% 0' }}>
                      <CRow>
                    ...
                    <div className="form-block">
                      <div className="form-group" style={{ color: '#6D4D4D', margin: '1% 0' }}>
                        <CRow>
                    ...
                    <div className="form-group col-md-6" style={{ margin: '5% 0' }}>
                      <div className="form-block-title">
                        <h5 style={{ color: '#6D4D4D', margin: '1% 0' }}>Acil Durumda İrtibata Geçilecek Kişi</h5>
                      </div>
                    </div>
                    ...
                    <div className='d-flex justify-content-center' style={{ margin: '3% 0' }}>
                      <CButton
                        type="submit"
